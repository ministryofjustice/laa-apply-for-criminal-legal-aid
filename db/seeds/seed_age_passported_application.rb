...
# -----------------------------------------------------------------------------
# Applicant – DOB makes them 16 years old at date_stamp, triggering both
# IOJ and means passporting via Passporting::AGE_PASSPORTED_UNTIL = 18.years
# -----------------------------------------------------------------------------

applicant = Applicant.create!(
  crime_application: app,
  first_name: 'Age Passported',
  last_name: 'Applicant',
...
# IojPassporter sets ioj_passport: [IojPassportType::ON_AGE_UNDER18]
# MeansPassporter sets means_passport: [MeansPassportType::ON_AGE_UNDER18]
# Both passported – no IOJ record or income/capital/outgoings records needed
...
# -----------------------------------------------------------------------------
# Review form (no partner info, no IOJ, no means records – all passported)
# -----------------------------------------------------------------------------
...
# -----------------------------------------------------------------------------
# Declaration – no partner, no partner declaration required
# -----------------------------------------------------------------------------
