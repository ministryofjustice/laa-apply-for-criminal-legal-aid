  ...
  let(:body) do
    {
      'search' => {
        ...
        'review_status' => expected_review_status_filter,
        'office_code' => '1A123B'
      },
      'pagination' => { 'page' => nil, 'per_page' => nil },
      'sorting' => { 'sort_direction' => 'descending', 'sort_by' => 'submitted_at' }
    }
  end

  let(:expected_review_status_filter) { nil }
  let(:expected_status_filter) { nil }
  let(:expected_search_text) { nil }
