  ...
  describe '#answers' do
    ...
    context 'when there are income details' do
      it 'has the correct rows' do
        ...
        expect(answers[0].change_path).to match('applications/12345/steps/income/how_does_client_manage_with_no_income')
        ...
        expect(answers[1].change_path).to match('applications/12345/steps/income/how_does_client_manage_with_no_income')
