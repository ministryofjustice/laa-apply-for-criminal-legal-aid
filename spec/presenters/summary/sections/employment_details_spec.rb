    ...
    context 'when there are income details' do
      context 'and the client is not working' do
        ...
        it 'has the correct rows' do
          ...
          expect(answers[2].change_path)
            .to match('applications/12345/steps/income/did_client_lose_job_being_in_custody')
      ...
      context 'and the client is employed' do
        ...
        it 'has the correct rows' do
          ...
          expect(answers[1].change_path).to match('applications/12345/steps/income/client/armed_forces')
