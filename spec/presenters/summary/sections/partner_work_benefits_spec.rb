...
describe Summary::Sections::PartnerWorkBenefits do
  ...
  let(:income) do
    instance_double(
      Income,
      partner_other_work_benefit_received: partner_other_work_benefit_received,
      partner_work_benefits: income_payment
    )
  end
  ...
  describe '#show?' do
    context 'when there is an income' do
      context 'when partner_other_work_benefit_received is set to `yes`' do
