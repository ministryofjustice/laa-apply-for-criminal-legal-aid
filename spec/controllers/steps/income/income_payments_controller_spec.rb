...
RSpec.describe Steps::Income::IncomePaymentsController, type: :controller do
  it_behaves_like 'a generic step controller', Steps::Income::IncomePaymentsForm, Decisions::IncomeDecisionTree do
      ...
      context 'finishing income payments' do
        it 'has the expected step name' do
          expect(subject).to receive(:update_and_advance).with(
            Steps::Income::IncomePaymentsForm, as: :income_payments
          )
