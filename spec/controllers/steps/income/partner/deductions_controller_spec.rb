  ...
  describe '#update' do
    let(:expected_params) do
      {
        ...
        steps_income_partner_deductions_form: steps_income_partner_deductions_form
      }
    end

    let(:steps_income_partner_deductions_form) {
      {
        income_tax:,
        national_insurance:,
        types:,
    ...
    context 'when valid deduction attributes' do
      it 'redirects to `employments_summary` page' do
        ...
        expect(response).to redirect_to steps_income_partner_employments_summary_path
