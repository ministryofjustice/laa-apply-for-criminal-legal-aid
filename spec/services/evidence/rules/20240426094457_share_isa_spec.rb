...
RSpec.describe Evidence::Rules::ShareIsa do
  ...
  describe '.client' do
    ...
    context 'with share isa investments' do
      let(:investments) { [Investment.new(investment_type: 'share_isa', ownership_type: :applicant)] }
    ...
    context 'when not owned by client' do
      let(:investments) { [Investment.new(investment_type: 'share_isa', ownership_type: :partner)] }
  ...
  describe '.partner' do
    ...
    context 'when not owned by partner' do
      let(:investments) { [Investment.new(investment_type: 'share_isa', ownership_type: :client)] }
  ...
  describe '#to_h' do
    let(:investments) do
      [
        Investment.new(investment_type: 'share_isa', ownership_type: :applicant),
        Investment.new(investment_type: 'share_isa', ownership_type: :partner),
      ]
    end
