module Steps
  class BaseFormObject
    ...
    # TODO: Move? Mix this in to steps where applicable rather than the base class
    def subject_aware_error_message(attr, error: 'blank', conjunction: :or)
      scope = [:activemodel, :errors, :models, model_name.to_s.underscore, :attributes]

      subject = I18n.t("dictionary.subject.#{ownership_type}", conjunction:)
