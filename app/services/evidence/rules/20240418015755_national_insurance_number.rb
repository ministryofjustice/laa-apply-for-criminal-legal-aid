  ...
  module Rules
    class NationalInsuranceNumber < Rule
      ...
      client do |crime_application|
        ...
        has_nino = crime_application.applicant&.nino.present?

        !has_nino && (income_benefits.any? || (status.present? && BenefitCheckStatus.new(status).no_check_no_nino?))
      end
      ...
      partner do |crime_application|
        ...
        has_nino = crime_application.partner&.nino.present?
